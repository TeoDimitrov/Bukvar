...
public class Level0122 extends AppCompatActivity {
    private static final String WORD = "хвърчило";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_22_h_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_22h);
        ...
        this.nextActivityClass = Level0123.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0121.class;
