...
public class Level0121 extends AppCompatActivity {
    private static final String WORD = "фея";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_21_f_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_21f);
        ...
        this.nextActivityClass = Level0122.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0120.class;
