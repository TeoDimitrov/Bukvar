...
public class Level0113 extends AppCompatActivity {
    private static final String WORD = "мече";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_13_m_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_13m);
        ...
        this.nextActivityClass = Level0114.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0112.class;
