...
public class Level0115 extends AppCompatActivity {
    private static final String WORD = "охлюв";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_15_o_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_15o);
        ...
        this.nextActivityClass = Level0116.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0114.class;
