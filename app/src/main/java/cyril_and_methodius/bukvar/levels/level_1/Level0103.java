...
public class Level0103 extends AppCompatActivity {
    private static final String WORD = "вода";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_03_v_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_03v);
        ...
        this.nextActivityClass = Level0104.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0102.class;
