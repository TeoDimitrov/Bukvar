...
public class Level0107 extends AppCompatActivity {
    private static final String WORD = "жираф";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_07_zh_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_07zh);
        ...
        this.nextActivityClass = Level0108.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0106.class;
