...
public class Level0119 extends AppCompatActivity {
    private static final String WORD = "тигър";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_19_t_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_19t);
        ...
        this.nextActivityClass = Level0120.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0118.class;
