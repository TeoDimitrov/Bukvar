...
public class Level0105 extends AppCompatActivity {
    private static final String WORD = "диван";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_05_d_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_05d);
        ...
        this.nextActivityClass = Level0106.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0104.class;
