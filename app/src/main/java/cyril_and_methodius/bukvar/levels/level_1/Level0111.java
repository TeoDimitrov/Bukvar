...
public class Level0111 extends AppCompatActivity {
    private static final String WORD = "книги";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_11_k_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_11k);
        ...
        this.nextActivityClass = Level0112.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0110.class;
