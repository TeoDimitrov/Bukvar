...
public class Level0123 extends AppCompatActivity {
    private static final String WORD = "цвете";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_23_c_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_23c);
        ...
        this.nextActivityClass = Level0124.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0122.class;
