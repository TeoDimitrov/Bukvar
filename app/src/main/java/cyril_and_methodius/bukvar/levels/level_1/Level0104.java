...
public class Level0104 extends AppCompatActivity {
    private static final String WORD = "грозде";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_04_g_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_04g);
        ...
        this.nextActivityClass = Level0105.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0103.class;
