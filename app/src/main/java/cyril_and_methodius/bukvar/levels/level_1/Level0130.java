...
public class Level0130 extends AppCompatActivity {
    private static final String WORD = "ягода";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_30_q_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_30q);
        ...
        this.nextActivityClass = Level0200.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0129.class;
