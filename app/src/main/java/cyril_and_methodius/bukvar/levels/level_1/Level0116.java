...
public class Level0116 extends AppCompatActivity {
    private static final String WORD = "прежда";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_16_p_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_16p);
        ...
        this.nextActivityClass = Level0117.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0115.class;
