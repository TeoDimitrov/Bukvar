...
public class Level0114 extends AppCompatActivity {
    private static final String WORD = "нинджи";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_14_n_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_14n);
        ...
        this.nextActivityClass = Level0115.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0113.class;
