...
public class Level0106 extends AppCompatActivity {
    private static final String WORD = "елен";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_06_e_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_06e);
        ...
        this.nextActivityClass = Level0107.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0105.class;
