...
public class Level0125 extends AppCompatActivity {
    private static final String WORD = "шапка";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_25_sh_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_25sh);
        ...
        this.nextActivityClass = Level0126.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0124.class;
