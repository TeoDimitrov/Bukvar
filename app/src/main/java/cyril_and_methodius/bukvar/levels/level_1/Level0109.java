...
public class Level0109 extends AppCompatActivity {
    private static final String WORD = "игла";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_09_i_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_09i);
        ...
        this.nextActivityClass = Level0110.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0108.class;
