...
public class Level0124 extends AppCompatActivity {
    private static final String WORD = "череша";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_24_ch_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_24ch);
        ...
        this.nextActivityClass = Level0125.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0123.class;
