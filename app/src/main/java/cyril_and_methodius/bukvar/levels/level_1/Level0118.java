...
public class Level0118 extends AppCompatActivity {
    private static final String WORD = "слон";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_18_s_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_18s);
        ...
        this.nextActivityClass = Level0119.class;
