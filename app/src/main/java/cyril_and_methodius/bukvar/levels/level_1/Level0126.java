...
public class Level0126 extends AppCompatActivity {
    private static final String WORD = "щъркел";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_26_sht_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_26sht);
        ...
        this.nextActivityClass = Level0127.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0125.class;
