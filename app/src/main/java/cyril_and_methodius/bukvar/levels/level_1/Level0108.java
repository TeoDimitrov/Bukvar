...
public class Level0108 extends AppCompatActivity {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_08_z_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_08z);
        ...
        this.nextActivityClass = Level0109.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0107.class;
