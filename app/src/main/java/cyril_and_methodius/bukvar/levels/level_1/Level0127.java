...
public class Level0127 extends AppCompatActivity {
    private static final String WORD = "ъгъл";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_27_y_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_27y);
        ...
        this.nextActivityClass = Level0128.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0126.class;
