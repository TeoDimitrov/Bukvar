...
public class Level0112 extends AppCompatActivity {
    private static final String WORD = "лале";
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.level_1_12_l_letter);

        //Image Media Player
        mediaPlayer = MediaPlayer.create(this, R.raw.sound_12l);
        ...
        this.nextActivityClass = Level0113.class;
        this.nextActivity = new Intent(this, this.nextActivityClass);
        this.previusActivityClass = Level0111.class;
